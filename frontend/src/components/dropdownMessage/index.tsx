...
import avatar from "../../assets/imgs/user/img1.jpg";
  ...
  return (
    <li className="relative" x-data="{ dropdownOpen: false, notifying: true }">
      <Link
        ...
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-grayblue hover:text-primary-500 dark:border-strokedark dark:bg-meta-4 dark:text-white"
        to="#"
      >
            ...
            <li key={i}>
              ...
              >
                <div className="h-12.5 w-12.5 rounded-full">
                  <img src={m.image} alt="User" className="rounded-full" />
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs">{m.timeStamp}</p>
                </div>
              </Link>
            </li>
          ))}
