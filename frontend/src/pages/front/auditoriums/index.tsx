...
const product = {
  ...
  details: [
    ...
    "I/We agree rhat there wil be no smoking eating, drinking or use of naked fire and incense in the auditorium",
...
export default FrontAuditorium;
