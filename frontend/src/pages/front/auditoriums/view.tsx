        ...
        <>
            {!loading && data != null && (
                <div className='px-6 py-24 sm:py-32 lg:px-8'>
                    <SectionTitle title="Our Auditoriums"></SectionTitle>
                            ...
                            data?.data?.map((item: any, i: number) => (
                                ...
                                >
                                    ...
                                    <Link to={`/auditorium/details/${item.audID}`}>
                                        <h2 className="mb-2 text-2xl font-bold tracking-tight text-indigo-900 dark:text-white hover:text-primary-600">
                                            {`${item.name} Hall`}
                                        </h2>
                                    </Link>
